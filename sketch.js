...
let maxIteracoes = 300;
let spawnProtection = 60;
let iteracoes = 0
let historiaGen = [];
let meteoros = [];
function setup() {
    meteoros.push(new Meteoro(createVector(width*3,height), 100, createVector(0,0)));
    meteoros.push(new Meteoro(createVector(width*16,height), 100, createVector(0,0)));
    meteoros.push(new Meteoro(createVector(width*16,height*8), 100, createVector(0,0)));
    meteoros.push(new Meteoro(createVector(width*3,height*8), 100, createVector(0,0)));
    
    for(let i=0; i<150; i++){
        grift.push(new Grift(meteoros,15));
        grift[i].num = i;
